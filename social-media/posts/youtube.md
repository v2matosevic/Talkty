...
(pick one)
- Talkty: local, private speech-to-text for Windows and macOS (free and open source)
...
It is also built for people who code by talking to an AI agent. An optional Prompting mode rewrites a rambling dictation into a clean, structured prompt for tools like Claude Code, Cursor, and Codex. Cloud transcription is there too if you ever want extra accuracy. Both are off by default.
...
Chapters:
0:00 Press your hotkey
0:08 Just talk
0:13 Clean text on your clipboard
0:18 Paste anywhere
0:23 Prompting for coding agents
